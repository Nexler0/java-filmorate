...
--таблица для связи директоров и фильма
...
--таблица для типов операций с событиями
...
(
    ...
    OPERATION_TYPE_ID INTEGER REFERENCES OPERATION_TYPE (OPERATION_TYPE_ID),
    EVENT_TIME        TIMESTAMP,
    ENTITY_ID         INTEGER
);

--таблица для связи пользователей и событий
CREATE TABLE IF NOT EXISTS EVENTS_USERS
(
    EVENTS_USER_ID int generated by default as identity,
