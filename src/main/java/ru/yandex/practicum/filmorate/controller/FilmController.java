...
public class FilmController {
    ...
    @GetMapping("/search")
    public List<Film> getFilmsWithRequestedParameters(@RequestParam String query, @RequestParam String by) {
        return filmService.getFilmsWithRequestedParameters(query, by);
    }
